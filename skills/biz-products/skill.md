...
description: >-
  ...
  operator's real stack, regardless of the model used. biz-products
  generate, biz-products extend, biz-products scope,
  biz-products audit, biz-products status.
---

# biz-products

**Canonical path:** `.ai.biz/skills/biz-products/skill.md`
...
| User says | Mode |
|-----------|------|
| `@biz-products generate - <space / seed>` | Produce 5–8 structured product/service concepts. |
| `@biz-products generate - <space> - count <n>` | Produce exactly n concepts. |
| `@biz-products extend - <existing product>` | Add-ons / extension concepts for an existing product. |
| `@biz-products scope - <concept name>` | Produce a ruthlessly minimal MVP definition for one concept. |
| `@biz-products audit - <concept name>` | Evaluate one concept against the quality bar; output Go/Refine/Kill. |
| `@biz-products status` | Read-only: report loaded stack, market, and proof points. |
...
- `@biz-ideas` — upstream; a business idea can be drilled into a product concept here.
...
- `@biz-writing` — write a case study or launch post for the concept.
...
| Skill | When |
|-------|------|
| `@biz-ideas` | Upstream business-idea layer |
...
| `@biz-writing` | Case study / launch content for the concept |