...
description: >-
  ...
  regardless of the model used. biz-ideas generate, biz-ideas stress,
  biz-ideas pivot, biz-ideas status.
---

# biz-ideas

**Canonical path:** `.ai.biz/skills/biz-ideas/skill.md`
...
| User says | Mode |
|-----------|------|
| `@biz-ideas generate - <domain / seed>` | Produce 5–8 structured ideas across archetypes. |
| `@biz-ideas generate - <domain> - count <n>` | Produce exactly n ideas. |
| `@biz-ideas stress - <idea name or index>` | Stress-test one idea: market, moat, ramp, risks. |
| `@biz-ideas pivot - <current situation>` | Generate pivot directions from an existing business. |
| `@biz-ideas status` | Read-only: report loaded operator context and constraints. |
...
- `@biz-products` — drill a business idea into a concrete product/service concept.
- `@biz-writing` — turn an idea into thought-leadership content.
...
| `@biz-products` | Turn a business idea into a buildable product/service concept |
| `@biz-strategy greenfield` | Formalize a chosen idea into the project's strategy |
| `@biz-writing` | Turn the idea into content that attracts early buyers |