...
### `@biz-social write youtube` — Long-form script (8–15 min)
...
### `@biz-social write youtube shorts` — Shorts script (15–60 sec, up to 3 min)
...
### `@biz-social research youtube` — Research methods
...
When running `@biz-social research youtube`, use these methods:
