...
Copy the `biz-project-query-setup` skill into the framework's skills directory so operators can invoke `@biz-project-query-setup install`:

```bash
cp -r /tmp/opencode/biz-project-query-setup \
      /path/to/framework/skills/biz-project-query-setup/
```
...
|-----------|------------|
| `.ai` | `/mnt/work/Projects/.ai/skills/biz-project-query-setup/skill.md` |
| `.ai.ui` | `/mnt/work/Projects/.ai.ui/skills/biz-project-query-setup/skill.md` |
| `.ai.biz` | `/mnt/work/Projects/.ai.biz/skills/biz-project-query-setup/skill.md` |
| `.ai.soc` | `/mnt/work/Projects/.ai.soc/skills/biz-project-query-setup/skill.md` |

Then register in each framework's `skills/README.md`:

```markdown
| `biz-project-query-setup` | Guide through tools-project key creation, MCP registration, connectivity test, and OS-specific usage patterns |
```

And add to each framework's `.cursorrules` § Skills table:

```markdown
| biz-project-query-setup | `/mnt/work/Projects/.ai/skills/biz-project-query-setup/` | Guided setup: API key creation, MCP registration, connectivity test. OS-aware (adapts guidance per OS). |
```
...
- [ ] `biz-project-query-setup/skill.md` copied to framework's `skills/`
...
- [ ] Agent calls `@biz-project-query-setup status` and sees green
...
|------|----------|---------|
| `skill.md` | Each framework's `skills/biz-project-query-setup/` | The guided setup skill |
