...
| # | What was done | Date |
|---|---------------|------|
| 0 | `@biz-archive` skill + `ideas/`/`ideas.archive/` canonization + per-piece status.md tracker slimming + Context budget convention; bootstrap/deploy/routing/verify wired; framework now 24 skills | 2026-08-19 |
