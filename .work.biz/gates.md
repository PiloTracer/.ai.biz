...
**Next gate:** strategy-ready — run `@biz-strategy greenfield` then `@biz-strategy certify`
...
**Status:** NOT MET
**Certified:** —
**By:** @biz-discovery run or @biz-proposal write
**Evidence:** `.work.biz/pipeline/pipeline_tracker.md` with at least one deal at Conversation stage or later
**Next gate:** active-deal — log a qualified deal in the pipeline tracker
