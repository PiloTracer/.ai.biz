...
This directory is the **project's memory** — it holds everything the Business OS skills and sessions produce:
...
> **Template — your project's HANDOFF.md will be filled by `@biz-session` and `@biz-review`**
