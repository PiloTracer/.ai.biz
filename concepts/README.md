...
Business concept prompts that guide strategic thinking and decision-making. Each concept maps to a specific business question or challenge.

## Available Concepts

| ID | Name | When to Run |
|----|------|-------------|
| BIZ-01 | Market Fit | Testing a new niche or offer |
| BIZ-02 | Pricing Model | Deciding pricing structure |
| BIZ-03 | Channel Strategy | Choosing go-to-market channels |
...
| Content mix is lopsided — one topic dominates | BIZ-09 Content Topic Buckets |
