...
- **Skills** — `@biz-strategy`, `@biz-brand`, `@biz-content`, `@biz-discovery`, `@biz-proposal`, … run the playbook (15 skills in total).
...
All **15** skills live under [`skills/`](skills/README.md). Invoke as `@<skill-id>` plus a mode.
